...
import * as MockData__sql$Executor from "./MockData__sql.mjs";

let mockNetworkHardware = [
  {
    vendor: "Cisco",
    category: "Router",
...
function createMockData(client, premise_id) {
  let query = MockData__sql$Executor.Query1.execute;
  let mockInventoryJson = JSON.stringify(mockNetworkHardware);
  return query(client, {
    mock_inventory: mockInventoryJson,
...
/* MockData__sql-Executor Not a pure module */
